            ...
            <tbody>
                @foreach ($expenses as $value)
                    <tr>
                        ...
                        <td>{{ $value->amount_date }}</td>
                        <td>
                            <a name="showExpense" href="{{ route('expenses.show',  ['id' => $value->id] ) }}" class="btn btn-secondary">
                                <i class="bi bi-search"></i>
                            </a>
                            <a name="editExpense" href="{{ route('expenses.edit',  ['id' => $value->id] ) }}" class="btn btn-secondary">
                                <i class="bi bi-pen"></i>
                            </a>
                            <button name="deleteExpense" data-id="{{ $value->id }}" type="button" class="btn btn-secondary">
                                <i class="bi bi-x-circle"></i>
                            </button>
                        </td>
                    </tr>
